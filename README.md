...
در تصویر زیر، دیاگرام کلاس‌های سیستم و روابط اصلی بین کلاس‌ها، اینترفیس‌ها و الگوهای طراحی استفاده‌شده (State، Strategy و Factory) نمایش داده شده است.

![دیاگرام کلاس‌ها](class-diagram.png)
